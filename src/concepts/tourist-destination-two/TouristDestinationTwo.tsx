...
const TouristDestinationTwo: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Update day/night image visibility on theme toggle
    if (dayImageRef.current && nightImageRef.current) {
      gsap.to(dayImageRef.current, {
        opacity: isNightMode ? 0 : 1,
        duration: 0.6,
        ease: "power2.inOut"
      })
      gsap.to(nightImageRef.current, {
  ...
  return (
    <div className={`w-screen min-h-screen relative overflow-hidden transition-all duration-1000 ${
      ...
      <section className="relative z-10 flex items-end justify-start min-h-[120vh] pb-16 px-8 sm:px-12 lg:px-16 overflow-hidden">
