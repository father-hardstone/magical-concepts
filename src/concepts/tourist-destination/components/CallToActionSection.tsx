  ...
  return (
    <section className="min-h-[55vh] flex items-center">
      <div className={`w-full overflow-hidden rounded-3xl border backdrop-blur-md px-6 py-12 sm:px-10 sm:py-16 text-center relative ${
        ...
        <h2 className={`relative text-3xl sm:text-4xl font-bold mb-4 transition-colors duration-1000 ${
          isNightMode ? 'text-white' : 'text-gray-900'
        }`}>
          Ready to Transform Tourism?
        </h2>
        <p className={`relative text-base sm:text-lg mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-1000 ${
          isNightMode ? 'text-gray-300' : 'text-gray-600'
        }`}>
          Let’s work together to create extraordinary destinations that feel effortless for visitors and profitable for operators—without sacrificing culture or sustainability.
        </p>
        <div className="relative flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          ...
          <button className={`px-7 py-3 rounded-full text-base font-semibold transition-all duration-300 transform hover:scale-[1.03] ${
            isNightMode 
